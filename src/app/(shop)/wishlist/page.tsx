        ...
        return (
            <div className="min-h-screen bg-stone-50 pt-32 pb-20">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <h1 className="text-3xl font-black text-stone-900 mb-4 italic">Sign in to save your love</h1>
                    <p className="text-stone-500 mb-10 max-w-md mx-auto italic">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[10px] font-black text-brand-amber uppercase tracking-[0.3em]">Treasury of Flavors</span>
                        </div>
                        <h1 className="text-4xl font-black text-stone-900 tracking-tight italic">My Wishlist</h1>
                        <p className="text-stone-500 mt-2 font-medium italic">Your handpicked selection of authentic traditions.</p>
                    </div>
                ...
                {!wishlist?.products || wishlist.products.length === 0 ? (
                    <div className="bg-white rounded-[3rem] p-16 text-center border border-stone-100 shadow-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-md mx-auto">
                            ...
                            <h2 className="text-2xl font-black text-stone-900 mb-4 italic">Your Wishlist is Empty</h2>
                            <p className="text-stone-500 mb-10 italic leading-relaxed">
