                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:h-full">
                    ...
                    <div className="max-w-[700px]">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-10 w-full sm:w-auto">
                            <Link href="/collections/garlic-pickles" className="bg-[#C76A2A] text-white px-[22px] py-[13px] rounded-[8px] font-poppins font-semibold text-[16px] leading-[100%] flex items-center justify-center text-center w-full sm:w-auto">
                                Shop Garlic Pickles
                            </Link>
