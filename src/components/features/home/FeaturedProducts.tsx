        ...
        <section className="py-24 bg-stone-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-4 tracking-tight">Our Signature Collection</h2>
                ...
                <div className="text-center mt-16">
                    <Link
                        ...
                        className="inline-flex items-center gap-2 bg-white border-2 border-amber-600 text-amber-700 hover:bg-amber-600 hover:text-white px-8 py-3 rounded-xl font-bold transition-all duration-300 shadow-sm"
                    >
