...
const artisans: Artisan[] = [
  {
    ...
    description: "Lakshmi has been cooking traditional recipes for over 20 years.",
    image: c1,
  },
  {
    id: 2,
    name: "Kamala Devi",
    role: "Spice Grinder",
    description: "Kamala specializes in hand-ground spice blends.",
    image: c2,
  },
  {
    id: 3,
    name: "Savita Devi",
    role: "Traditional Spice Artisan",
    description: "Savita has blended spices for over 15 years.",
    image: c3,
  },
  {
    id: 4,
    name: "Anjali Kumari",
    role: "Pickle Master",
    description: "Anjali crafts traditional pickles.",
    image: c4,
  },
  {
    id: 5,
    name: "Radha Sharma",
    role: "Textile Weaver",
    description: "Radha weaves intricate patterns.",
    image: c5,
  },
];
...
export default function ArtisansCarousel() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActive((prev) =>
        prev === artisans.length - 1 ? 0 : prev + 1
      );
    }, 3000);
  ...
  return (
    <section className="bg-[#fffaf3] py-20 overflow-hidden">
      ...
      <div className="text-center mb-14 px-4">
        <h2 className="font-cinzel font-bold uppercase text-[18px] sm:text-[22px] md:text-[28px] lg:text-[36px] text-[#a94f1d] mb-4">
          Meet the Artisans
        </h2>
        <p className="text-[#a94f1d]/80 max-w-xl mx-auto">
      ...
      <div className="relative flex items-center justify-center h-[480px] perspective-[1400px]">
        ...
        <button
          onClick={() =>
            setActive((p) => (p === 0 ? artisans.length - 1 : p - 1))
          }
